...
#ifndef ALIGNED_ALL_GATHER_ASYM_ALL_DOUBLE_RING_PUB_H
#define ALIGNED_ALL_GATHER_ASYM_ALL_DOUBLE_RING_PUB_H

#include "executor_base_pub.h"

namespace hccl {
class AlignedAllGatherAsymAllDoubleRing : public ExecutorBase {
public:
    explicit AlignedAllGatherAsymAllDoubleRing(const HcclDispatcher dispatcher, const HcomCollOpInfo *opInfo,
    ...
    ~AlignedAllGatherAsymAllDoubleRing() override;
...
#endif /* ALIGNED_ALL_GATHER_ASYM_ALL_DOUBLE_RING_PUB_H */