...
#ifndef ALLTOALL_V_PAIRWISE_PRO_PUB_H
#define ALLTOALL_V_PAIRWISE_PRO_PUB_H
...
class AlltoAllVPairWisePro {
public:
    explicit AlltoAllVPairWisePro(const HcclDispatcher dispatcher,
...
#endif /* ALLTOALL_V_PAIRWISE_PRO_PUB_H */