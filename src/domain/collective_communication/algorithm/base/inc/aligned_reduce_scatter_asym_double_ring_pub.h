...
#ifndef ALIGNED_REDUCE_SCATTER_ASYM_DOUBLE_RING_PUB_H
#define ALIGNED_REDUCE_SCATTER_ASYM_DOUBLE_RING_PUB_H
...
namespace hccl {
class AlignedReduceScatterAsymDoubleRing : public ExecutorBase {
public:
    explicit AlignedReduceScatterAsymDoubleRing(const HcclDispatcher dispatcher,
    ...
    ~AlignedReduceScatterAsymDoubleRing() override;
...
#endif /* ALIGNED_REDUCE_SCATTER_ASYM_DOUBLE_RING_PUB_H */
