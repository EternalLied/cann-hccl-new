...
#ifndef ALIGNED_ALL_GATHER_ASYM_DOUBLE_RING_PUB_H
#define ALIGNED_ALL_GATHER_ASYM_DOUBLE_RING_PUB_H

#include "executor_base_pub.h"

namespace hccl {
class AlignedAllGatherAsymDoubleRing : public ExecutorBase {
public:
    explicit AlignedAllGatherAsymDoubleRing(const HcclDispatcher dispatcher, const HcomCollOpInfo *opInfo,
    ...
    ~AlignedAllGatherAsymDoubleRing() override;
...
#endif /* ALIGNED_ALL_GATHER_ASYM_DOUBLE_RING_PUB_H */