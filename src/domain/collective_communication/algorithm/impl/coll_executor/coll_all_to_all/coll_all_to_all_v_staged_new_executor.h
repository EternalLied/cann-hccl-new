...
namespace hccl {
class CollRunAlltoAllVStagedNew : public CollAlltoAllExecutor {

public:
    CollRunAlltoAllVStagedNew(const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollRunAlltoAllVStagedNew() = default;
