...
#ifndef COLL_ALIGNED_ALLGATHER_RING_ASYM_NEW_EXECUTOR_H
#define COLL_ALIGNED_ALLGATHER_RING_ASYM_NEW_EXECUTOR_H
#include "coll_all_gather_ring_for_910_93_executor.h"
namespace hccl {
class CollAlignedAllGatherAsymNewDoubleRingExecutor : public CollAllGatherRingFor91093Executor {
public:
    explicit CollAlignedAllGatherAsymNewDoubleRingExecutor(const HcclDispatcher dispatcher,
        std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollAlignedAllGatherAsymNewDoubleRingExecutor() = default;
