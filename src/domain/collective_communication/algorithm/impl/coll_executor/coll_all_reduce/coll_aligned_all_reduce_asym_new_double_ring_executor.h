...
#ifndef COLL_ALIGNED_ALL_REDUCE_ASYM_NEW_DOUBLE_RING_EXECUTOR_H
#define COLL_ALIGNED_ALL_REDUCE_ASYM_NEW_DOUBLE_RING_EXECUTOR_H

#include "coll_all_reduce_ring_for_910_93_executor.h"

namespace hccl {
class CollAlignedAllReduceAsymNewDoubleRingExecutor : public CollAllReduceRingFor91093Executor {

public:
    CollAlignedAllReduceAsymNewDoubleRingExecutor(
        const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollAlignedAllReduceAsymNewDoubleRingExecutor() = default;
