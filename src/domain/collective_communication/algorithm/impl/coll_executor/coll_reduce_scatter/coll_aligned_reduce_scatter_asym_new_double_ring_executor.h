...
#ifndef COLL_ALIGNED_REDUCESCATTER_ASYM_NEW_DOUBLE_RING_EXECUTOR_H
#define COLL_ALIGNED_REDUCESCATTER_ASYM_NEW_DOUBLE_RING_EXECUTOR_H
#include "coll_reduce_scatter_ring_for_910_93_executor.h"

namespace hccl {
class CollAlignedReduceScatterAsymNewDoubleRingExecutor : public CollReduceScatterRingFor91093Executor {
public:
    explicit CollAlignedReduceScatterAsymNewDoubleRingExecutor(
        const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollAlignedReduceScatterAsymNewDoubleRingExecutor() = default;
